...
void iDraw() {
	...
	iLine(50,50,gx,gy);
	draw_bird1(bx,800);//1
	draw_bird2(bx+150,800);//2
	draw_bird3(bx+300,800);//3
	draw_bird4(bx+450,800);//4
	draw_bird5(bx+600,800);//5
...
int main() {
	...
	iSetTimer(1,birdchange);
	//iSetTimer(10,arrowchange);
	//iMouseMove(6,7);
    dx=1;
	iInitialize(1024, 900, "demo");
	return 0;
}